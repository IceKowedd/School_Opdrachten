package frl.icekowedd.School_Opdr88.Opdracht_4;
...
public class Counsellor {
  ...
  private int age;
  private static final ArrayList<frl.icekowedd.School_Opdr88.Opdracht_4.Counsellor> counsellors = new ArrayList<>();
  ...
  public static List<frl.icekowedd.School_Opdr88.Opdracht_4.Counsellor> getCounsellors() {
    return counsellors;
  }
  ...
  public static void addNewCounsellor(Scanner scanner) {
    ...
    frl.icekowedd.School_Opdr88.Opdracht_4.Counsellor newCounsellor = new frl.icekowedd.School_Opdr88.Opdracht_4.Counsellor(name, email, residence, age, phoneNumber,
        workerNumber);
  ...
  public static void printCounsellor() {
    ...
    if (getCounsellors().isEmpty()) {
      ...
      for (frl.icekowedd.School_Opdr88.Opdracht_4.Counsellor counsellor : getCounsellors()) {
